...
export default function InfoPanel({ sourceText, targetText }: InfoPanelProps) {
      ...
      <CardContent className="p-4">
        <div className="space-y-6">
          <div className="space-y-2">
            <h3 className="font-medium">Texto original</h3>
          ...
          <div className="space-y-2">
            <h3 className="font-medium">Texto traduzido</h3>
            <div className="grid grid-cols-2 gap-1 text-sm">
              <div>Linhas:</div>
